...
import { acessoAtivoDaTurma } from '../utils/auxiliares';
...
export const AuxiliarAlunoPerfilPage = () => {
  ...
  // aluno (ver utils/auxiliares.js). Se o aluno mudar de turma, o acesso muda junto. Exige
  // também que a turma esteja ativa: histórico de vínculo preservado não é acesso preservado.
  const vinculoAtivo = aluno ? acessoAtivoDaTurma(pdiAuxiliaresVinculos, turmas, aluno.turmaId) : null;
