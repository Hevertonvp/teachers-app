...
export const ListaProfessores = () => {
  ...
  const columns = [
    { key: 'professor', header: 'Professor(a)', render: row => <ProfessorName professor={row} /> },
  ...
  return (
    <MainLayout>
      <div className="space-y-6">
        <div>
          <h1 className="text-3xl font-bold text-slate-950">Gestão de Professores(as)</h1>
