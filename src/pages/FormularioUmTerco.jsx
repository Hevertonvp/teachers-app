...
import { BackButton, Badge, Button, Card, EmptyState, FormField } from '../components/Common';
...
// Um card por escola (vigência, período atual, envio) — usado tanto pelo professor com uma
// única escola quanto, repetido, pelo professor com várias (ver TeacherFormularioUmTerco
// abaixo). Nada aqui depende do seletor de escola do topo.
const EscolaFormularioUmTerco = ({ user, escola, formularios, formPeriods, createFormulario, updateFormulario }) => {
...
export const FormularioUmTerco = () => {
  ...
  return <TeacherFormularioUmTerco user={user} userEscolas={userEscolas} formularios={formularios} formPeriods={formPeriods} createFormulario={createFormulario} updateFormulario={updateFormulario} />;
};
